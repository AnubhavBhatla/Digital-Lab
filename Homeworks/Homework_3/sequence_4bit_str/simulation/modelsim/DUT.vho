...
-- Equation(s):
-- \shift_reg~3_combout\ = (\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_cdr~0_combout\ & (!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & ((\io~regout\))))
...
-- Equation(s):
-- \dut_instance|add_instance|dff_2|Q~regout\ = DFFEAS((\dut_instance|add_instance|dff_1|Q~regout\ $ ((\dut_instance|add_instance|dff_2|Q~regout\))), GLOBAL(dut_input(0)), !dut_input(1), , , , , , )
...
PORT MAP (
	...
	datab => \dut_instance|add_instance|dff_1|Q~regout\,
	datac => \dut_instance|add_instance|dff_2|Q~regout\,
	datad => \dut_instance|add_instance|dff_3|Q~regout\,
	aclr => dut_input(1),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
