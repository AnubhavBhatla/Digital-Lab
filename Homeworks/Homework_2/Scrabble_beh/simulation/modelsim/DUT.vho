...
SIGNAL \add_instance|Y~combout\ : std_logic;
...
\add_instance|Y\ : maxv_lcell
-- Equation(s):
-- \add_instance|Y~combout\ = (\input_vector~combout\(0) & (!\input_vector~combout\(1) & (\input_vector~combout\(3) $ (!\input_vector~combout\(2))))) # (!\input_vector~combout\(0) & (\input_vector~combout\(1) & (\input_vector~combout\(3) $ 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \add_instance|Y~combout\);
