...
-- Equation(s):
-- \add_instance|y_present.rst~regout\ = DFFEAS((!\add_instance|outp~combout\ & (!\input_vector~combout\(1) & ((\add_instance|Equal0~0_combout\) # (\add_instance|y_present.rst~regout\)))), GLOBAL(\input_vector~combout\(0)), VCC, , , , , , )
...
PORT MAP (
	...
	datac => \add_instance|outp~combout\,
	datad => \input_vector~combout\(1),
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \add_instance|outp~combout\ = (!\input_vector~combout\(6) & (\add_instance|Equal2~0_combout\ & (!\input_vector~combout\(3) & \add_instance|y_present.s4~regout\)))
