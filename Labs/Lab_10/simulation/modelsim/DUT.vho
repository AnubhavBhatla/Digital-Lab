...
-- Equation(s):
-- div_clk(20) = DFFEAS((((\Add0~60_combout\))), GLOBAL(\clk~combout\), VCC, , , , , , )
...
\Equal0~2\ : maxv_lcell
-- Equation(s):
-- \Equal0~2_combout\ = (!\Add0~55_combout\ & (!\Add0~45_combout\ & (\Add0~40_combout\ & !\Add0~50_combout\)))
...
\Equal1~1\ : maxv_lcell
-- Equation(s):
-- \Equal1~1_combout\ = (\Add0~140_combout\ & (!\Add0~150_combout\ & (!\Add0~155_combout\ & \Add0~145_combout\)))
...
-- Equation(s):
-- div_clk(6) = DFFEAS((\Add0~120_combout\ & (((!\Equal0~7_combout\) # (!\Equal1~0_combout\)) # (!\Equal1~1_combout\))), GLOBAL(\clk~combout\), VCC, , , , , , )
...
\Equal0~8\ : maxv_lcell
-- Equation(s):
-- \Equal0~8_combout\ = (\Add0~135_combout\ & (!\Add0~120_combout\ & (\Add0~130_combout\ & !\Add0~125_combout\)))
...
\Equal0~9\ : maxv_lcell
-- Equation(s):
-- \Equal0~9_combout\ = (!\Add0~140_combout\ & (\Add0~150_combout\ & (\Add0~155_combout\ & !\Add0~145_combout\)))
...
-- Equation(s):
-- \lcd_instance|lcd_en~regout\ = DFFEAS((\lcd_instance|state.S1~regout\) # ((\lcd_instance|Selector10~0_combout\) # ((!\lcd_instance|lcd[1]~0_combout\ & \lcd_instance|lcd_en~regout\))), GLOBAL(\lcd_clk~regout\), VCC, , !\rst~combout\, , , , )
...
PORT MAP (
	...
	datad => \lcd_instance|Selector10~0_combout\,
	aclr => GND,
...
-- Equation(s):
-- \covid_det_instance|y_present.s1~regout\ = DFFEAS((\covid_det_instance|Equal1~0_combout\ & (\covid_det_instance|Selector1~0_combout\ & ((!\covid_det_instance|y_present.init~regout\)))) # (!\covid_det_instance|Equal1~0_combout\ & 
-- ((\covid_det_instance|y_present.s1~regout\) # ((\covid_det_instance|Selector1~0_combout\ & !\covid_det_instance|y_present.init~regout\)))), GLOBAL(\clk_slow~combout\), !GLOBAL(\rst~combout\), , , , , , )
...
-- Equation(s):
-- \covid_det_instance|y_present.s2~regout\ = DFFEAS((\covid_det_instance|y_present.s2~regout\ & (((\covid_det_instance|Equal1~0_combout\ & \covid_det_instance|y_present.s1~regout\)) # (!\covid_det_instance|Equal2~1_combout\))) # 
...
PORT MAP (
	clk => \clk_slow~combout\,
	dataa => \covid_det_instance|y_present.s2~regout\,
...
-- Equation(s):
-- \covid_det_instance|Selector3~0_combout\ = (\covid_det_instance|Equal2~0_combout\ & (\inp~combout\(1) & (\inp~combout\(4) & \covid_det_instance|y_present.s2~regout\)))
...
-- Equation(s):
-- \covid_det_instance|y_present.init~regout\ = DFFEAS((\covid_det_instance|y_present.s4~regout\ & (!\covid_det_instance|Equal4~0_combout\ & ((\covid_det_instance|Selector1~0_combout\) # (\covid_det_instance|y_present.init~regout\)))) # 
-- (!\covid_det_instance|y_present.s4~regout\ & ((\covid_det_instance|Selector1~0_combout\) # ((\covid_det_instance|y_present.init~regout\)))), GLOBAL(\clk_slow~combout\), !GLOBAL(\rst~combout\), , , , , , )
...
\Equal2~2\ : maxv_lcell
-- Equation(s):
-- \Equal2~2_combout\ = (!i(14) & (!i(13) & (!i(12) & !i(11))))
...
\Equal2~1\ : maxv_lcell
-- Equation(s):
-- \Equal2~1_combout\ = (!i(9) & (!i(8) & (!i(10) & !i(7))))
...
\Equal6~0\ : maxv_lcell
-- Equation(s):
-- \Equal6~0_combout\ = (((!\Equal2~4_combout\) # (!\Equal2~10_combout\)) # (!\Equal2~8_combout\)) # (!i(2))
...
-- Equation(s):
-- \write_column[2]~5_combout\ = (\lcd_instance|ack~regout\ & (((!\Equal2~9_combout\) # (!\Equal6~0_combout\))))
...
-- Equation(s):
-- \Equal2~11_combout\ = (\Equal2~10_combout\ & (!i(2) & (\Equal2~4_combout\ & \Equal2~8_combout\)))
...
-- Equation(s):
-- \write_data~7_combout\ = (((write_data(0) & !\rst~combout\)))
...
-- Equation(s):
-- \write_data~5_combout\ = (write_data(0) & (\Equal6~0_combout\ & (!\rst~combout\ & !\Equal5~0_combout\)))
...
\Equal3~0\ : maxv_lcell
-- Equation(s):
-- \Equal3~0_combout\ = (!i(1) & (((i(0) & !\Equal2~9_combout\))))
...
-- Equation(s):
-- \write_data~6_combout\ = (\write_data~2_combout\) # ((\write_data~3_combout\ & ((\write_data~5_combout\) # (\write_data~4_combout\))))
...
-- Equation(s):
-- \write_column[2]~1_combout\ = (\rst~combout\) # ((\lcd_instance|ack~regout\ & ((!\Equal2~9_combout\) # (!\Equal6~0_combout\))))
...
-- Equation(s):
-- \lcd_instance|Selector1~0_combout\ = (!\lcd_instance|state.S2~regout\ & (((\lcd_instance|state.S0~regout\ & !\lcd_instance|state.S1~regout\))))
...
-- Equation(s):
-- write_column(1) = DFFEAS((\lcd_instance|ack~regout\ & ((\Equal2~11_combout\) # ((\Equal3~0_combout\) # (!\Equal6~0_combout\)))), GLOBAL(\lcd_clk~regout\), VCC, , \write_column[2]~1_combout\, , , , )
...
-- Equation(s):
-- \write_data~8_combout\ = (\Equal4~0_combout\ & ((\covid_det_instance|y_present.s4~regout\) # ((\covid_det_instance|y_present.s3~regout\) # (\covid_det_instance|Selector3~0_combout\))))
...
-- Equation(s):
-- \write_data~10_combout\ = (\write_data~9_combout\ & (!\Equal5~0_combout\ & (!\Equal4~0_combout\ & \Equal6~0_combout\)))
...
-- Equation(s):
-- \write_data~11_combout\ = (\write_data~2_combout\) # ((!\Equal3~0_combout\ & ((\write_data~8_combout\) # (\write_data~10_combout\))))
...
-- Equation(s):
-- \covid_det_instance|outp~0_combout\ = (\covid_det_instance|Equal2~0_combout\ & (!\inp~combout\(1) & (!\inp~combout\(4) & \covid_det_instance|y_present.s4~regout\)))
...
-- Equation(s):
-- \write_data~26_combout\ = (\lcd_instance|ack~regout\ & ((i(1)) # ((\Equal2~9_combout\) # (i(0)))))
...
-- Equation(s):
-- write_column(2) = DFFEAS((\lcd_instance|ack~regout\ & (!i(1) & ((!\Equal2~9_combout\)))), GLOBAL(\lcd_clk~regout\), VCC, , \write_column[2]~1_combout\, , , , )
...
-- Equation(s):
-- \lcd_instance|Selector3~0_combout\ = (!\lcd_instance|count_cmd\(1) & (!\lcd_instance|count_cmd\(2) & (!\lcd_instance|lcd[7]~1\ & !\lcd_instance|count_cmd\(0))))
...
PORT MAP (
	clk => \lcd_clk~regout\,
	dataa => \lcd_instance|Selector3~0_combout\,
